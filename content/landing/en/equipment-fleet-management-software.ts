...
const page: LandingPage = {
  ...
  description:
    "Track every machine in your fleet by QR code: location, condition, documents and compliance. Import your existing file. From 179 € excl. VAT per month.",
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Pricing",
      paragraphs: [
        "179 € excl. VAT per month, 100 assets included and unlimited users. Above 100 assets the rate tapers, and the product is designed for fleets of 50 to 2,000 machines.",
      ],
